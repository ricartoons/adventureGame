...
const map = [
  ...
  { id: 1, name: 'WaterFall', directions: [{name: 'down', idNextScenario: 4}, {name: 'back', idNextScenario: 0}], objects: [], description: 'There is a waterfall right in front of you, you calculate that it is not very high, but it does not seem clever to dive from this height' },
  ...
  { id: 6, name: 'Island beach', directions: [{name: 'old woods', idNextScenario: 7}, {name: 'temple', idNextScenario: 8}, {name: 'cemetery', idNextScenario: 9}, {name: 'boat', idNextScenario: 5}], objects: ['lamp'], description: ''},
  { id: 7, name: 'Old woods', directions: [{name: 'beach', idNextScenario: 6}, {name: 'temple', idNextScenario: 8},  {name: 'cemetery', idNextScenario: 9}, {name: 'back', idNextScenario: 6} ], objects: ['knife'], description: ''},
  { id: 8, name: 'Temple', directions: [{name: 'old woods', idNextScenario: 7}, {name: 'enter temple', idNextScenario: 10}, {name: 'beach', idNextScenario: 8},  {name: 'cemetery', idNextScenario: 9}, {name: 'back', idNextScenario: 6} ], objects: [], description: ''},
  { id: 9, name: 'Cemetery', directions: [{name: 'old woods', idNextScenario: 7}, {name: 'temple', idNextScenario: 8},  {name: 'beach', idNextScenario: 6}, {name: 'back', idNextScenario: 6} ], objects: ['shovel'], description: ''},
